...
/**
 * Job and run statuses share this map on purpose: `succeeded` and `completed`
 * are the same fact at two altitudes, and the reader should not have to learn
 * two colour languages to see it.
 */
...
export const LiveDot = ({ connected }: { connected: boolean }) => (
  <span className="flex items-center gap-1.5 text-xs text-muted">
    <span className={cn("size-1.5 rounded-full", connected ? "bg-ok" : "bg-bad animate-pulse")} />
